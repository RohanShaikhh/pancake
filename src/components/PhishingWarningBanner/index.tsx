...
const PhishingWarningBanner: React.FC<React.PropsWithChildren> = () => {
  ...
  const warningTextAsParts = useMemo(() => {
    const warningText = t("please make sure you're visiting  https://freeswap - check the URL carefully.", { domain })
    ...
    <Container className="warning-banner">
      {isMobile || isMd ? (
        ...
        <>
          <InnerContainer>
            <img
              src="https://openseauserdata.com/files/47234a2441ba48a43317588122361b82.png"
              alt="phishing-warning"
              width="92px"
              onError={(e) => {
                const fallbackSrc = 'https://openseauserdata.com/files/47234a2441ba48a43317588122361b82.png'
